...
namespace IIS.ISS34
{
    ...
    public class Support : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.ISS34.Form fForm;
        
        private IIS.ISS34.DetailArrayOfListInv fListInv;
        
        private IIS.ISS34.DetailArrayOfListSize fListSize;
        ...
        [NotNull()]
        public virtual IIS.ISS34.Form Form
        {
            get
            {
                ...
                IIS.ISS34.Form result = this.fForm;
        ...
        public virtual IIS.ISS34.DetailArrayOfListInv ListInv
        {
            get
            {
                ...
                {
                    this.fListInv = new IIS.ISS34.DetailArrayOfListInv(this);
                }
                IIS.ISS34.DetailArrayOfListInv result = this.fListInv;
        ...
        public virtual IIS.ISS34.DetailArrayOfListSize ListSize
        {
            get
            {
                ...
                {
                    this.fListSize = new IIS.ISS34.DetailArrayOfListSize(this);
                }
                IIS.ISS34.DetailArrayOfListSize result = this.fListSize;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View SupportE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("SupportE", typeof(IIS.ISS34.Support));
                }
            }
            ...
            public static ICSSoft.STORMNET.View SupportL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("SupportL", typeof(IIS.ISS34.Support));
                }
            }
        }
    }
