...
namespace IIS.ISS34
{
    ...
    public class ListSize : ICSSoft.STORMNET.DataObject
    {
        ...
        [NotNull()]
        public virtual IIS.ISS34.Size Size
        {
            get
            {
                ...
                IIS.ISS34.Size result = this.fSize;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ListSizeE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ListSizeE", typeof(IIS.ISS34.ListSize));
                }
            }
        }
    }
    ...
    public class DetailArrayOfListSize : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.ISS34.DetailArrayOfListSize members)

        // *** End programmer edit section *** (IIS.ISS34.DetailArrayOfListSize members)
        ...
        /// </summary>
        public DetailArrayOfListSize(IIS.ISS34.Support fSupport) : 
                base(typeof(ListSize), ((ICSSoft.STORMNET.DataObject)(fSupport)))
        {
        }
        
        public IIS.ISS34.ListSize this[int index]
        {
            get
            {
                return ((IIS.ISS34.ListSize)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.ISS34.ListSize dataobject)
        {
